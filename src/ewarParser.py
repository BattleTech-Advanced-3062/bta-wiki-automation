...
def process_ecm_files(directories):
    ecm_dict = {}
    excluded_patterns = {"", ""}
    extra_files = [bta_dir + "BT Advanced Gear/upgrade/general/Gear_Sensors_StealthField.json", bta_dir + "BT Advanced Gear/upgrade/general/Gear_Guardian_ECM_SLDF.json"]
